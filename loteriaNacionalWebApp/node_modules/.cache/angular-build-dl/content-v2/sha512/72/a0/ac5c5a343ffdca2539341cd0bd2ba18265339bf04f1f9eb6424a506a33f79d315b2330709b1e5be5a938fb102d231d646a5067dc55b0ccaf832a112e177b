...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<app-navbar *ngIf=\"!isDetail\"></app-navbar>\n<router-outlet></router-outlet>\n<app-footer *ngIf=\"!isDetail\"></app-footer>";
    /***/
  },
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | lottery-lottery-module */
        [__webpack_require__.e("default~inquiry-inquiry-module~landing-landing-module~lottery-lottery-module~payment-payment-module"), __webpack_require__.e("default~lottery-lottery-module~payment-payment-module"), __webpack_require__.e("lottery-lottery-module")]).then(__webpack_require__.bind(null,
        /*! ./lottery/lottery.module */
        "./src/app/lottery/lottery.module.ts")).then(function (m) {
          return m.LotteryModule;
        });
      }
    }, {
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~inquiry-inquiry-module~landing-landing-module~lottery-lottery-module~payment-payment-module"), __webpack_require__.e("default~inquiry-inquiry-module~landing-landing-module"), __webpack_require__.e("landing-landing-module")]).then(__webpack_require__.bind(null,
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~inquiry-inquiry-module~landing-landing-module~lottery-lottery-module~payment-payment-module"), __webpack_require__.e("default~lottery-lottery-module~payment-payment-module")]).then(__webpack_require__.bind(null,
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~inquiry-inquiry-module~landing-landing-module~lottery-lottery-module~payment-payment-module"), __webpack_require__.e("default~inquiry-inquiry-module~landing-landing-module")]).then(__webpack_require__.bind(null,
        /*! ./inquiry/inquiry.module */
        "./src/app/inquiry/inquiry.module.ts")).then(function (m) {
      ...
      function AppComponent(router) {
        ...
        this.router.events.subscribe(function (event) {
          if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationStart"]) {
            var data = decodeURIComponent(event.url);

            if (data.includes("compra_tus_juegos?token")) {
              var url = data.split("?token=")[0];
              _this.token = data.split("?token=")[1];

              _this.router.navigateByUrl("".concat(url, "/").concat(_this.token));
            }
            ...
            if (data.includes("payment/detalle")) {
              ...
              if (data.includes("?ticketId")) {
                _url = data.split("?ticketId=")[0];
                ticketId = data.split("?ticketId=")[1];

                _this.router.navigateByUrl("".concat(_url, "/").concat(ticketId));
              }
            }
          }
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_11__["MatPaginatorModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_12__["MatFormFieldModule"]],
      exports: [_angular_material_paginator__WEBPACK_IMPORTED_MODULE_11__["MatPaginatorModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_12__["MatFormFieldModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"]],
      providers: [
        /* {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/angeloacr/Proyectos/loteriaNacional/app/loteriaNacionalWebApp/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
