...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(FaLayersComponent, [{
    ...
    }], function () { return [{ type: Renderer2 }, { type: ElementRef }, { type: FaConfig }]; }, { constructor: [], renderer: [], elementRef: [], config: [], ngOnInit: [], fixedWidth: [{
            type: Input
        }, {
            type: HostBinding,
            args: ['class.fa-fw']
