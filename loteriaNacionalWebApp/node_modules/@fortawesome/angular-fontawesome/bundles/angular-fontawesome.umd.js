(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/platform-browser'), require('@fortawesome/fontawesome-svg-core'),require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@fortawesome/angular-fontawesome', ['exports', '@angular/core', '@angular/platform-browser', '@fortawesome/fontawesome-svg-core','@angular/core'], factory) :
...
}(this, (function (exports, i0, platformBrowser, fontawesomeSvgCore,ɵngcc0) { 
const _c0 = ["*"];
const _c1 = [1, "ng-fa-icon"];
const _c2 = [1, "ng-fa-layers-counter"];
const _c3 = [1, "ng-fa-layers-text"];
'use strict';
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(FaConfig, [{
    ...
    }], function () { return []; }, { defaultPrefix: [], fallbackIcon: [], globalLibrary: [] });
        return FaConfig;
    }());
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(FaIconLibrary, [{
        type: i0.Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return []; }, { definitions: [], addIcons: [], addIconPacks: [], getIconDefinition: [] });
...
FaStackComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: FaStackComponent, selectors: [["fa-stack"]], factory: function FaStackComponent_Factory(t) { return new (t || FaStackComponent)(ɵngcc0.ɵɵdirectiveInject(i0.Renderer2), ɵngcc0.ɵɵdirectiveInject(i0.ElementRef)); }, inputs: { size: "size" }, features: [ɵngcc0.ɵɵNgOnChangesFeature()], ngContentSelectors: _c0, consts: 1, vars: 0, template: function FaStackComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(FaStackComponent, [{
    ...
    }], function () { return [{ type: i0.Renderer2 }, { type: i0.ElementRef }]; }, { renderer: [], elementRef: [], ngOnInit: [], ngOnChanges: [], size: [{
            type: i0.Input
        }] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(FaIconComponent, [{
    ...
    }], function () { return [{ type: platformBrowser.DomSanitizer }, { type: FaConfig }, { type: FaIconLibrary }, { type: FaStackItemSizeDirective, decorators: [{
                type: i0.Optional
            }] }, { type: FaStackComponent, decorators: [{
                type: i0.Optional
            }] }]; }, { sanitizer: [], config: [], iconLibrary: [], stackItem: [], classes: [{
            type: i0.Input
...
FaLayersComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: FaLayersComponent, selectors: [["fa-layers"]], factory: function FaLayersComponent_Factory(t) { return new (t || FaLayersComponent)(ɵngcc0.ɵɵdirectiveInject(i0.Renderer2), ɵngcc0.ɵɵdirectiveInject(i0.ElementRef), ɵngcc0.ɵɵdirectiveInject(FaConfig)); }, hostBindings: function FaLayersComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ɵngcc0.ɵɵallocHostVars(1);
        ɵngcc0.ɵɵstyling();
    } if (rf & 2) {
        ɵngcc0.ɵɵclassProp("fa-fw", ctx.fixedWidth);
        ɵngcc0.ɵɵstylingApply();
    } }, inputs: { fixedWidth: "fixedWidth", size: "size" }, features: [ɵngcc0.ɵɵNgOnChangesFeature()], ngContentSelectors: _c0, consts: 1, vars: 0, template: function FaLayersComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef();
        ɵngcc0.ɵɵprojection(0);
    } }, encapsulation: 2 });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(FaLayersComponent, [{
    ...
    }], function () { return [{ type: i0.Renderer2 }, { type: i0.ElementRef }, { type: FaConfig }]; }, { renderer: [], elementRef: [], config: [], ngOnInit: [], fixedWidth: [{
            type: i0.Input
        }, {
            type: i0.HostBinding,
            args: ['class.fa-fw']
...
FaLayersCounterComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: FaLayersCounterComponent, selectors: [["fa-layers-counter"]], factory: function FaLayersCounterComponent_Factory(t) { return new (t || FaLayersCounterComponent)(ɵngcc0.ɵɵdirectiveInject(FaLayersComponent, 8), ɵngcc0.ɵɵdirectiveInject(platformBrowser.DomSanitizer)); }, hostBindings: function FaLayersCounterComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ɵngcc0.ɵɵallocHostVars(1);
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(FaLayersCounterComponent, [{
        ...
        args: [{
                ...
                type: i0.Optional
            }] }, { type: platformBrowser.DomSanitizer }]; }, { parent: [], sanitizer: [], classes: [{
            type: i0.Input
...
FaLayersTextComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: FaLayersTextComponent, selectors: [["fa-layers-text"]], factory: function FaLayersTextComponent_Factory(t) { return new (t || FaLayersTextComponent)(ɵngcc0.ɵɵdirectiveInject(FaLayersComponent, 8), ɵngcc0.ɵɵdirectiveInject(platformBrowser.DomSanitizer)); }, hostBindings: function FaLayersTextComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ɵngcc0.ɵɵallocHostVars(1);
