...
export declare class FaIconComponent implements OnChanges {
    ...
    private renderIcon;
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<FaIconComponent, "fa-icon", never, { 'classes': "classes", 'icon': "icon", 'title': "title", 'spin': "spin", 'pulse': "pulse", 'mask': "mask", 'styles': "styles", 'flip': "flip", 'size': "size", 'pull': "pull", 'border': "border", 'inverse': "inverse", 'symbol': "symbol", 'rotate': "rotate", 'fixedWidth': "fixedWidth", 'transform': "transform", 'a11yRole': "a11yRole" }, {}, never>;
}
