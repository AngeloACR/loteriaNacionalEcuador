...
@Component({
  ...
  templateUrl: './la-millonaria-consulta.component.html',
  styleUrls: ['./la-millonaria-consulta.component.scss']
})
export class LaMillonariaConsultaComponent implements OnInit {
  sorteosJugados: any;
  sorteoGanador: any;
  sorteoBoletin: any;
  ...
  async ngOnInit() {
    ...
    this.sorteosJugados = await this.inquiryService.recuperarSorteosJugados(14);
