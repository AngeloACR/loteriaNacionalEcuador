...
const ResultadoMillonaria = require("../model/resultadoMillonaria");
...
const resultadosController = {
  ...
  addResultadoMillonaria: async function (element) {
    try {
      let newResultado = new ResultadoMillonaria(element);
      let resultado = await newResultado.save();
      let response = {
        status: true,
        values: resultado,
    ...
    try {
      ...
      switch (tipoLoteria) {
        ...
        case "2":
          ...
          ultimoResultado.resultadoAntojito = element.resultadoAntojito;
          ultimoResultado.codigoPremioLottoPlus = element.codigoPremioLottoPlus;
          ultimoResultado.codigoPremioLottito = element.codigoPremioLottito;
          ultimoResultado.codigoPremioNosVemosJefe =
            element.codigoPremioNosVemosJefe;
  ...
  getResultadosMillonaria: async function (sorteo) {
    try {
      let sorteoAux = `${sorteo}`;
      let query = { numeroSorteo: sorteoAux };
