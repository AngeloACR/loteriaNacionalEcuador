      ...
      _createClass(InquiryService, [{
        ...
        value: function recuperarSorteosJugados(tipoLoteria) {
          ...
          switch (tipoLoteria) {
            ...
            case 14:
              endpoint = "".concat(endpoint, "/millonariaSorteosJugados");
              console.log("Recuperando sorteos de pozo millonario");
              break;
        ...
        value: function recuperarBoletoGanador(tipoLoteria, sorteo, combinaciones) {
          ...
          switch (tipoLoteria) {
            ...
            case 14:
              endpoint = "".concat(endpoint, "/ganadorMillonaria");
        ...
        value: function obtenerBoletin(tipoLoteria, sorteo) {
          ...
          switch (tipoLoteria) {
            ...
            default:
              endpoint = "".concat(endpoint, "/millonariaBoletin");
              break;
          }
          ...
          return new Promise(function (resolve, reject) {
            _this17.http.post(address, body, {
              headers: headers
            }).subscribe(function (data) {
              var boletin = data;
              console.log(boletin);
