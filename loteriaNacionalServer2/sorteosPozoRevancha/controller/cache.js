...
const cacheController = {
  getUltimoResultado: async (req, res) => {
    try {
      ...
      let response = await client.get("ultimoResultadoPozoRevancha");
      if (response == "") {
        await cacheController.setUltimoResultado();
        response = await client.get("ultimoResultadoPozoRevancha");
      }
      await client.quit();
  ...
  setUltimoResultado: async () => {
    try {
      ...
      await client.connect();
      await client.set("ultimoResultadoPozoRevancha", JSON.stringify(response));
      await client.quit();
    } catch (e) {
  ...
  getSorteos: async () => {
    try {
      let client = redis.getClient();
      await client.connect();
      let response = await client.get("pozoRevanchaSorteos");
      if (response == "") {
        await cacheController.setSorteos();
        response = await client.get("pozoRevanchaSorteos");
      }
      await client.quit();
  ...
  setSorteos: async () => {
    try {
      ...
      await client.set("pozoRevanchaSorteos", JSON.stringify(sorteos));
      await client.quit();
    } catch (e) {
      console.log(e.toString());
    }
  ...
  setSorteosDisponibles: async () => {
    try {
      ...
      await client.set(
        "pozoRevanchaSorteosDisponibles",
  ...
  getSorteosDisponibles: async () => {
    try {
      let client = redis.getClient();
      await client.connect();
      let response = await client.get("pozoRevanchaSorteosDisponibles");
      if (!response) {
        await cacheController.setSorteosDisponibles();
        response = await client.get("pozoRevanchaSorteosDisponibles");
      }
      await client.quit();
      return JSON.parse(response);
    } catch (e) {
