    ...
    var LotteryService = /*#__PURE__*/function () {
      ...
      _createClass(LotteryService, [{
        ...
        value: function obtenerSorteo(token, loteria) {
          ...
          var address = "";
          var endpoint = "/cache/sorteosDisponibles";
          var authData = this.getAuthData();
          ...
          return new Promise(function (resolve, reject) {
            _this2.http.get(address, {
              ...
              var sorteosDisponibles = data;
              sorteosDisponibles.sort(_this2.ordenaSorteos);
        ...
        value: function obtenerTickets(token, loteria, sorteo, combinacion, combinacionFigura, tipoSeleccion) {
          ...
          endpoint = "".concat(endpoint, "/combinacionesDisponibles");
        ...
        value: function obtenerImagenBoleto(tipoLoteria, sorteo) {
          var sourceBoletos = "".concat(this.mySource, "/uploads/boletos/");
          return new Promise(function (resolve, reject) {
            var boletoAddress = "".concat(sourceBoletos, "B").concat(tipoLoteria).concat(sorteo, ".png");
        ...
        value: function reservarBoletos(token, boleto, tipoLoteria, reservaId) {
          ...
          var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
          headers = headers.append("Content-Type", "application/json");
          var address = "/reservas";
          var endpoint = "/reservarBoletos";
          address = this.mySource + address + endpoint;
          var authData = this.getAuthData();
          var body = {
            lotteryToken: authData.lotteryToken,
        ...
        value: function eliminarBoletosDeReserva(token, boleto, sorteo, fracciones, tipoLoteria, reservaId) {
          ...
          headers = headers.append("Content-Type", "application/json");
          var address = "/reservas";
          var endpoint = "/eliminarBoletosDeReserva";
          address = this.mySource + address + endpoint;
          var authData = this.getAuthData();
          var body = {
            lotteryToken: authData.lotteryToken,
      ...
      _createClass(LoaderComponent, [{
        ...
        value: function ngOnInit() {
          switch (this.loader) {
            ...
            case "millonaria":
              this.logoPath = "assets/img/millonaria-consulta.png"; //this.logoPath = "assets/pozoLoader.gif";
