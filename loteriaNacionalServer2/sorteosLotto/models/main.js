...
resultadoLottoSchema.index({ numeroSorteo: 1, combinacion1: 1 }); // schema level

module.exports = db.model("ResultadoLotto", resultadoLottoSchema);
