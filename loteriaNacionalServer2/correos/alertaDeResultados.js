      ...
      Messages: [
        {
          ...
          Variables: {
            ...
            millonaria: data.millonaria.status,
            millonariaSorteo: data.millonaria.sorteo,
            millonariaArchivoResultados: data.millonaria.archivoResultados,
            millonariaLengthResultados: data.millonaria.lengthResultados,
            millonariaCantidadResultados: data.millonaria.cantidadResultados,
            millonariaArchivoPremios: data.millonaria.archivoPremios,
            millonariaLengthPremios: data.millonaria.lengthPremios,
            millonariaCantidadPremios: data.millonaria.cantidadPremios,
            millonariaArchivoGanadores: data.millonaria.archivoGanadores,
