...
const resultadoBingazoSchema = new mongoose.Schema(
  {
    combinacion1: {
      type: String,
    },
...
resultadoBingazoSchema.virtual("premio", {
...
resultadoBingazoSchema.virtual("sorteo", {
...
resultadoBingazoSchema.statics = {
...
resultadoBingazoSchema.index({ numeroSorteo: 1, combinacion1: 1 }); // schema level
resultadoBingazoSchema.index({ numeroSorteo: 1, codigo: 1 }); // schema level

module.exports = db.model("ResultadoBingazo", resultadoBingazoSchema);
